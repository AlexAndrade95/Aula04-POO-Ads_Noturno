 ...
 * @author AlexAndrade
 */
@WebServlet(name = "AlexMathServlet", urlPatterns = {"/alex-calc.html"})
public class AlexMathServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AlexMathServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AlexMathServlet at " + request.getContextPath() + "</h1>");
